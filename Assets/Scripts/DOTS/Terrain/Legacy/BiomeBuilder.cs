...
/// 
/// ⚠️ LEGACY SYSTEM: This builder is primarily used with the legacy TerrainEntityManager and DOTS.Terrain.Legacy.TerrainData component.
...
namespace DOTS.Terrain.Legacy
{
    public static class BiomeBuilder
    {
        ...
        public static BlobAssetReference<BiomeTerrainData> CreateBiomeTerrainData(BiomeType biomeType)
        {
            ...
            {
                UnityEngine.Debug.LogError($"BiomeBuilder: Error disposing BlobBuilder: {e.Message}");
            }
