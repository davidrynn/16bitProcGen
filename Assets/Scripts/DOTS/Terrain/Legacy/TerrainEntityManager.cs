...
/// <summary>
/// [LEGACY] Manages terrain entity creation and destruction for the legacy DOTS.Terrain.Legacy.TerrainData system.
...
namespace DOTS.Terrain.Legacy
{
    public class TerrainEntityManager : MonoBehaviour
    {
        ...
        public Entity FindTerrainEntityAt(int2 chunkPosition)
        {
            ...
            foreach (var entity in entities)
            {
                var terrainData = entityManager.GetComponentData<DOTS.Terrain.Legacy.TerrainData>(entity);
        ...
        private void CleanupTerrainData(Entity entity)
        {
            ...
            if (entityManager.HasComponent<DOTS.Terrain.Legacy.TerrainData>(entity))
            {
                var terrainData = entityManager.GetComponentData<DOTS.Terrain.Legacy.TerrainData>(entity);
