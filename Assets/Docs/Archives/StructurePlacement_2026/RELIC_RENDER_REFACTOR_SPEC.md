...
_Status: ARCHIVED (2026-07-02) — IMPLEMENTED; superseded by `RELIC_LOD_IMPOSTOR_SPEC.md` §8. Moved from `Assets/Docs/AI/STRUCTURE_PLACEMENT/` to `Archives/StructurePlacement_2026/` (doc cleanup batch D4)._
_Superseded By: [RELIC_LOD_IMPOSTOR_SPEC.md](../../AI/STRUCTURE_PLACEMENT/RELIC_LOD_IMPOSTOR_SPEC.md)_
